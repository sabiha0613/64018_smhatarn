...
```{r}
cbind( price=get.sensitivity.rhs(lprec)$duals[1:11],lowerRange=get.sensitivity.rhs(lprec)$dualsfrom[1:11],upperRange=get.sensitivity.rhs(lprec)$dualstill[1:11])

cbind( cost=get.sensitivity.rhs(lprec)$duals[12:21],lowerRange=get.sensitivity.rhs(lprec)$dualsfrom[12:21],upperRange=get.sensitivity.rhs(lprec)$dualstill[12:21])
```
